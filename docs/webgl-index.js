...
// vec2 cloudRayMarch(vec3 rayOrigin, vec3 rayDirection, float hitDist, float near, float far)
// {
//     float depth = near;
//     float density = 0.0;
//     for (int i = 0; i < uMaxMarchingSteps; i++)
